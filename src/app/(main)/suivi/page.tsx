  ...
  return (
    <div className="min-h-screen bg-[var(--cream)]">
      <div className="bg-[var(--black-2)] py-12 text-center">
        ...
        <p className="mt-2 text-[var(--grey-lt)]">Le suivi public se fait désormais via un lien unique envoyé par email.</p>
      </div>
      ...
      <div className="mx-auto max-w-3xl space-y-6 px-4 py-10 sm:px-6">
        <section className="rounded-[2rem] border border-[var(--cream-3)] bg-white p-6 md:p-8">
          ...
          <h2 className="mt-3 font-bebas text-4xl text-[var(--black)]">Utiliser le lien reçu</h2>
          <p className="mt-4 text-sm leading-relaxed text-[var(--grey)]">
            Chaque commande payée reçoit un lien de suivi unique. Ouvre ce lien depuis l’email de confirmation ou de suivi pour voir ton avancement.
          </p>
        </section>
