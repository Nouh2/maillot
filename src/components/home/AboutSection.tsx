...
export function AboutSection() {
  return (
    <section className="bg-[var(--cream)] px-4 py-10 md:px-6 md:py-16">
      <div className="mx-auto max-w-7xl md:grid md:grid-cols-2 md:gap-16 md:items-center">
        {/* Colonne gauche : texte */}
        <div>
          <p className="mb-3 font-condensed text-[11px] font-semibold uppercase tracking-[0.15em] text-[var(--terra)]">MAILLOT ADDICT</p>

          <h2 className="font-condensed text-[26px] md:text-4xl font-bold leading-snug text-[var(--black)]">
        ...
        <div className="mt-6 md:mt-0 space-y-4">
          <div className="flex items-center gap-4 rounded-xl bg-white p-4" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
            <div>
          ...
          <div className="text-center md:text-left bg-[var(--cream-2)] rounded-xl p-6" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.04)' }}>
            <p className="font-condensed text-[52px] md:text-[64px] font-black leading-none text-[var(--black)]">+1 200</p>
