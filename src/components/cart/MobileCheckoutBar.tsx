...
export function MobileCheckoutBar() {
  ...
  return (
    <div className="fixed bottom-[var(--ma-sticky-bottom-offset)] left-0 right-0 z-50 border-t border-[var(--cream-3)] bg-white px-4 pb-[env(safe-area-inset-bottom,16px)] pt-3 shadow-[0_-4px_24px_rgba(0,0,0,0.08)] lg:hidden">
